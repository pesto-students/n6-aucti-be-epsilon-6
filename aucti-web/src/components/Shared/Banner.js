...
export const Banner = () => {
  return (
    <div
      data-testid="banner_component"
      className="flex flex-col xl:py-0 xs:py-10 w-80 xl:pr-4"
    >
      <div
        data-testid="Hot_Auctions"
        className="w-full xl:mt-4 xl:mx-2 xl:mb-7  xs:mb-4 relative overflow-hidden bg-yellow-500 rounded-lg max-w-xs shadow-lg  py-10"
      >
